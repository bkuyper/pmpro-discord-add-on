<form method="post" action="#">
  	...
  	<p>
  		...
  		<?php if(get_option('ets_discord_client_id')): ?>
  			<a href="?action=discord-connectToBot" class="ets-btn btn-connect-to-bot" id="connect-discord-bot"><?php echo __( "Connect Bot", "ets_pmpro_discord" );?> <i class='fab fa-discord'></i></a>
  		<?php endif; ?>
  	</p>
</form>
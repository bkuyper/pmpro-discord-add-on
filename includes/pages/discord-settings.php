<form method="post" action="#">
	...
	<div class="ets-input-group">
	  <label><?php echo __( 'Client ID', 'ets_pmpro_discord' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_discord_client_id" value="
		<?php
		if ( isset( $ets_discord_client_id ) ) {
			echo $ets_discord_client_id;}
		?>
		" required placeholder="Discord Client ID">
	</div>
	<div class="ets-input-group">
	  <label><?php echo __( 'Client Secret', 'ets_pmpro_discord' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_discord_client_secret" value="
		<?php
	...
	<div class="ets-input-group">
	  <label><?php echo __( 'Redirect URL', 'ets_pmpro_discord' ); ?> :</label>
		...
		<?php
		if ( isset( $ets_discord_redirect_url ) ) {
			echo $ets_discord_redirect_url;}
		?>
		" required>
	...
	<div class="ets-input-group">
	  <label><?php echo __( 'Bot Token', 'ets_pmpro_discord' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_discord_bot_token" value="
		<?php
	...
	<div class="ets-input-group">
	  <label><?php echo __( 'Guild Id', 'ets_pmpro_discord' ); ?> :</label>
		...
		placeholder="Discord Guild Id" value="
		<?php
		if ( isset( $ets_discord_guild_id ) ) {
			echo $ets_discord_guild_id;}
		?>
		" required>
	</div>
